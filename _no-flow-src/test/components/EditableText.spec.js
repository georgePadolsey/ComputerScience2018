...
describe('EditableText component', () => {
  ...
  it('should be able to be disabled', () => {
    ...
    expect(component
      ...
      .at(0)
      .instance()
      .getAttribute('contentEditable')).toEqual('false');
  });
  ...
  it('should call onChange evt on change', () => {
    ...
    const component = mount(<EditableText html={testText} onChange={onChangeSpy} />);
  ...
  it('should call onChange evt & onBlur evt on blur', () => {
    const onChangeSpy = spy();
    const onBlurSpy = spy();
    const component = mount(<EditableText html={testText} onChange={onChangeSpy} onBlur={onBlurSpy} />);
