...
export default function uiReducer(state: UIData = defaultUIState, action: actionType) {
  ...
  switch (action.type) {
    ...
    case SET_PROFILE_CREATOR_STAGE:
      ret = Object.assign({}, state, { profileCreatorState: { stage: action.payload } });
      saveData();
      break;
    case SET_PROFILE_CREATOR_CURRENT_CURRENCY:
      ret = Object.assign({}, state, { profileCreatorState: { currencySelected: action.payload } });
      saveData();
      break;
    case SET_PROFILE_CREATOR_CURRENT_EXCHANGE:
      ret = Object.assign({}, state, { profileCreatorState: { exchangeSelected: action.payload } });
      saveData();
      break;
    default:
      return state;
