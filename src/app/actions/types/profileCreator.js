...
export const PROFILE_CREATOR_SET_CURRENT_CURRENCY = 'PROFILE_CREATOR_SET_CURRENT_CURRENCY';
export const PROFILE_CREATOR_SET_CURRENT_EXCHANGE = 'PROFILE_CREATOR_SET_CURRENT_EXCHANGE';
export const PROFILE_CREATOR_SET_OFFERED = 'PROFILE_CREATOR_SET_OFFERED';
export const PROFILE_CREATOR_SET_BALANCE_NAME = 'PROFILE_CREATOR_SET_BALANCE_NAME';
export const PROFILE_CREATOR_SET_BALANCE_AMOUNT = 'PROFILE_CREATOR_SET_BALANCE_AMOUNT';
